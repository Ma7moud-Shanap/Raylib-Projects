...
Pet: raylib
ifneq (,$(Pet_config))
	@echo "==== Building Pet ($(Pet_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f Pet.make config=$(Pet_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f Pet.make clean
